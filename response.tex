...
\jd{
One possibility: We have added some visual aids to Figure 1: we color the backward incubation periods (the main driver of differences), and we have made them a little shorter to reflect what happens early in the epidemic. We explain this briefly in the caption. This does not seem to cover the whole suggestion, though. We could add text in S3 referring back to this -- it's hard to think of anything else that wouldn't be a pain, but suggestions are welcome.
}
