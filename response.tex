...
It is straightforward to see this relationship from Eq. (10) (by substituting $j(t) \approx j(0) \exp(rt)$ and $\Rs(t) \approx \Ro$);
...
``For example, forward generation intervals often become shorter as an epidemic progresses due to the dynamical fact of susceptible depletion, as well as due to other factors like behavioral change or interventions \citep{kenah2008generation, nishiura2010time, champredon2015intrinsic}: if it is harder to infect later in the course of infection, then proportionally more intervals will be short.''
...
We end the introduction by providing examples of how off $\RR$ estimates are in applications.
...
\jd{I notice that you didn't fiddle the lengths. This might be worth doing.}
...
\jd{We can add some text to the bottom of this \P, and maybe also refer back to Fig. 1 here.}
