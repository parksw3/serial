...
We believe it would be premature to try to explain the biases in Figure 1: the goal of this figure is to explain the intervals (to readers who are likely to be less familiar than the reviewer). 

\jd{
We have, however, added some visual aids to the figure: we color the backward incubation periods (the main driver of differences), and we have made them a little shorter to reflect what happens early in the epidemic. We explain this briefly in the caption.
}
