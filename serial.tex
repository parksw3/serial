...
In this case, $x_0$ follows the forward incubation period distribution of the cohort of infectors who became infected at time $\pt$;
$\gtime$ follows the forward generation interval of the cohort of infectors who became infected at time $\pt$;
and $x_1$ follows the forward incubation period of the cohort of infectees who became infected at time $\pt+\gtime$.
(B) The forward serial interval for a primary cohort $\pt$ (i.e., the cohort of infectors who became symptomatic at time $\pt$).
In this case, $x_0$ follows the backward incubation period distribution of the cohort of infectors who became symptomatic at time $\pt$;
$\sigma$ represents the forward generation interval;
and $x_1$ represents the forward incubation period of the infectee.
(C) The backward serial interval for a secondary cohort $\delta$ (i.e., the cohort of infectees who became symptomatic at time $\delta$).
