...
This conceptual framework clearly demonstrates that the distributions of $x_0$, $\delta$, and $x_1$ depend on the perspective as well as time and therefore cannot be treated statically.

Then, the total number of serial intervals 
