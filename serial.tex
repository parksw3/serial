...
Therefore, we expect the forward serial-interval distribution during the exponential growth phase --- which we refer to as the \emph{initial} forward serial-interval distribution $f_0$ --- to estimate the same values of \Ro from $r$ as the intrinsic generation-interval distribution:
\begin{equation}
