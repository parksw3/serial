...
However, these studies rely on \emph{intrinsic} distributions of incubation periods and generation intervals that neglect the population-level dynamics of the disease spread.
...
\subsection{Simulations with correlated intrinsic incubation periods and intrinsc generation intervals.}
