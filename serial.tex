...
length $\tau$. 
\jd{I need to keep thinking about what a cohort is for incubation period. Here, you seem to be putting people who don't show symptoms into the forward but not the backward cohort. How sure are you that this is right? The non-symptomatic people also seem to have $\tau$s?}
...
and the forward delay distribution $f_{\ssymp-\tau}(\tau)$ (in this case, the probability density that someone who was infected at time $\ssymp-\tau$ became symptomatic at time $\ssymp$).
