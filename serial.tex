...
We see that the denominator of the forward serial-interval distribution, $\int_{-\infty}^\infty \total(\psymp, \psymp+\tau') \dtau'$, then corresponds to the total number of symptomatic cases generated by primary cases who developed at time \psymp (\eref{fserial});
...
we further assume $\Ro=2.5$ to reflect the transmission dynamics of COVID-19 \citep{doi:10.1098/rsif.2020.0144}.
