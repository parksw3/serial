...
We develop a novel framework for understanding serial intervals and show that both serial- and generation-interval distributions give identical estimates of $\mathcal R$ during the exponential growth phase of an epidemic.
